...
public abstract class Organization {
    ...
    public enum Type{
        Admin("Admin Organization"), Doctor("Doctor Organization"), Lab("Lab Organization"), Assign("Assigning Authority"), Certify("Certifying Authority"), Receptionist("Receptionist Organization"), PotentialDonor("Potential Donor");
