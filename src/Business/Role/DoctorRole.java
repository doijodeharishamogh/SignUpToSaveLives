...
import userinterface.campDoctor.CampDoctorWorkAreaJPanel;
...
public class DoctorRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business, Network network) {
        if(enterprise.getEnterpriseType().toString().equals("Hospital Enterprise"))
            ...
            return new CampDoctorWorkAreaJPanel(userProcessContainer, account, (DoctorOrganization)organization, enterprise, network);
    }
