...
public class LabAssistantWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : labOrganization.getWorkQueue().getWorkRequestList()){
                ...
                row[0] = request;
                row[1] = ((LabTestWorkRequest) request).getPatientID();
                row[2] = request.getSender().getEmployee().getName();
                row[3] = ((LabTestWorkRequest)request).getReceiver() == null ? null : ((LabTestWorkRequest)request).getReceiver().getEmployee().getName();
                row[4] = request.getStatus();
                row[5] = ((LabTestWorkRequest)request).getTestResult();
    ...
    private void initComponents() {
        ...
        labrequestjTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Message", "PatientID", "Sender", "Reciever", "Status", "Organ Affected"
            }
        ) {
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(assignToMeBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 208, Short.MAX_VALUE)))))
                .addContainerGap())
        );
    ...
    private void assignToMeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignToMeBtnActionPerformed
       int selectedRow = labrequestjTable.getSelectedRow();
        ...
        request.setStatus("Testing In Progress");
        populateTable();
    ...
    private void processBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processBtnActionPerformed
        ...
        if (selectedRow < 0){
            ...
            LabTestWorkRequest request = (LabTestWorkRequest)labrequestjTable.getValueAt(selectedRow, 0);
